...
async def save_group(bot, message):
    ...
    if temp.ME in r_j_check:
        ...
        buttons = [[
                    ...
                    InlineKeyboardButton("ʙᴏᴛ ᴏᴡɴᴇʀ", url="t.me/faheemkhatri7861")
                  ]]
        reply_markup=InlineKeyboardMarkup(buttons)
        await message.reply_text(
            text=f"<b>ᴛʜᴀɴᴋs ғᴏʀ ᴀᴅᴅɪɴɢ ᴍᴇ ɪɴ {message.chat.title} ❣️\n\nɪғ ʏᴏᴜ ʜᴀᴠᴇ ᴀɴʏ ϙᴜᴇsᴛɪᴏɴs ᴏʀ ᴅᴏᴜʙᴛs ᴀʙᴏᴜᴛ ᴜsɪɴɢ ᴍᴇ, ᴄᴏɴᴛᴀᴄᴛ sᴜᴘᴘᴏʀᴛ.</b>",
            reply_markup=reply_markup)
    else:
                ...
                temp.MELCOW['welcome'] = await message.reply_video(
                                                 ...
                                                 reply_markup=InlineKeyboardMarkup(
                                                                         [[
                                                                           ...
                                                                           InlineKeyboardButton("ʙᴏᴛ ᴏᴡɴᴇʀ", url="t.me/Faheem21025492006")
                                                                         ]]
                                                 ),
...
async def leave_a_chat(bot, message):
    ...
    try:
        buttons = [[
            InlineKeyboardButton('sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ',url="https://t.me/Faheem21025492006"),
            InlineKeyboardButton("ʙᴏᴛ ᴏᴡɴᴇʀ", url="t.me/faheemkhatri7861")
        ],[
            InlineKeyboardButton('ᴜsᴇ ᴍᴇ ʜᴇʀᴇ', url=f'https://t.me/movieriqvestatoz')
        ]]
        reply_markup=InlineKeyboardMarkup(buttons)
